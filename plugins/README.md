...
| [pr-review-toolkit](./pr-review-toolkit/) | Comprehensive PR review agents specializing in comments, tests, type design, code quality, and code simplification | **Command:** `/pr-review-toolkit:review-pr` - Run with optional review aspects (comments, tests, types, code, simplify, all)<br>**Agents:** `comment-analyzer`, `pr-test-analyzer`, `type-design-analyzer`, `code-reviewer`, `code-simplifier` |
